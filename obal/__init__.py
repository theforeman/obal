...
def find_targets(inventory_path):
    ...
    if os.path.exists(inventory_path):
        from ansible.inventory.manager import InventoryManager # pylint: disable=import-outside-toplevel
        from ansible.parsing.dataloader import DataLoader # pylint: disable=import-outside-toplevel
...
def main(cliargs=None, application_config=ApplicationConfig):  # pylint: disable=R0914
    ...
    from ansible.utils.display import Display # pylint: disable=import-outside-toplevel
    ...
    from ansible.cli.playbook import PlaybookCLI # pylint: disable=import-outside-toplevel
